...
## 关键概念
- [[概念-RAG]]：Faithfulness/相关性/准确率是 RAG 专项评估指标，RAGAS 框架提供自动化评估
- [[方法-Prompt工程]]：Prompt 版本管理是可观测性的重要组成部分，每次 Prompt 变更需要记录版本并在日志中体现
- [[概念-Function-Calling]]：Agent 工具调用的成功率、失败类型是生产化监控的重要指标
