...
## 关键概念
- [[方法-Prompt工程]]：Prompt 设计的系统方法，涵盖 temperature 调节、Few-shot、CoT、对话历史管理等
- [[概念-RAG]]：RAG 系统的上下文组装本质是 Prompt 工程的一部分，文档如何放入 Prompt 直接影响效果
- [[概念-Function-Calling]]：工具调用需要严格的 Prompt 格式，temperature 应设为 0-0.1
...
## 延伸方向
- 可拆分为 [[方法-Prompt工程]] concept 页（temperature/top-p 等参数详解）
- 可延伸到 RAG Prompt 组装的最佳实践（连接到 [[主题-RAG系统设计]] summary）
