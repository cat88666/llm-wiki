...
Claude 是由 **Anthropic** 开发的大型语言模型家族，以其强大的长上下文处理能力和细致推理而闻名。Claude 系列模型强调有用性、无害性和诚实性（HHH 原则）。
...
| 版本 | 思考模式 | 配置方式 |
|------|----------|----------|
| Claude 4.5 | 扩展思考 | `budget_tokens` |
| Claude 4.6 | 自适应思考 | `effort` 参数 |
...
### 核心原则
1. **清晰直接**：给出明确、无歧义的指令
2. **使用示例**：3-5 个示例是最可靠的控制方式
3. **XML 结构化**：使用 XML 标签分隔不同组件
4. **角色设定**：通过系统提示设置角色
