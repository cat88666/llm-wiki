...
## 在知识库中的出现
- [[概念-RAG]] concept：Qdrant 是 RAG 系统向量存储层的典型工具，提供向量存储、检索和过滤能力
- [[方法-混合检索]] concept：Qdrant 的 sparse vector 支持使其成为混合检索的一体化解决方案，无需单独维护 BM25 引擎
- [[主题-RAG系统设计]] summary：作为开源方案中工程成熟度较高的向量数据库，是 RAG 基础设施选型的首选
