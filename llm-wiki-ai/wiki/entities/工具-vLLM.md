...
## 在知识库中的出现
- [[机制-KV-Cache]] concept：PagedAttention 是 KV Cache 显存管理的核心工程创新，解决传统连续分配的碎片化和利用率低问题
- [[主题-LLM核心机制与推理优化]] summary：vLLM 是 KV Cache 优化的工程实现代表，将理论优化转化为生产可用的工具
- [[主题-LLM生产化与评估]] summary：vLLM 是 LLM 生产化推理基础设施的首选方案
...
- [[工具-LangFuse]]：可观测性工具，与 vLLM 组合提供完整的生产推理监控链路
