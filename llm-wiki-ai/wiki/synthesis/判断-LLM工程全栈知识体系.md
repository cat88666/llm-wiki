...
参见：[[主题-机器学习基础理论]] / [[概念-集成学习]] / [[方法-正则化]] / [[方法-梯度下降与优化]]
...
参见：[[主题-Transformer架构原理]] / [[机制-Self-Attention]] / [[机制-多头注意力]]
...
参见：[[主题-LLM核心机制与推理优化]] / [[机制-KV-Cache]] / [[机制-FlashAttention]] / [[方法-分布式训练]] / [[概念-Tokenizer]]
...
参见：[[主题-Prompt工程实践]] / [[主题-RAG系统设计]] / [[主题-Agent与工具调用]]
...
**工具**：[[工具-LangFuse]] 是开源首选，提供 Trace/Span、Prompt 版本管理、评估数据集管理。
...
参见：[[主题-LLM生产化与评估]] / [[工具-LangFuse]] / [[工具-vLLM]]
