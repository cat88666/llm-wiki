...
Google 官方于 2024 年 9 月发布的提示工程白皮书，作者 Lee Boonstra。系统介绍了提示工程的技术原理、配置参数和高级技巧。
...
- **系统提示**：设置整体上下文和目的
- **角色提示**：分配特定角色（旅行向导、编辑等）
- **上下文提示**：提供具体背景信息

**3. 高级技术**
- **回退式提示**：先问一般性问题再解决具体任务，激活背景知识
- **思维链（CoT）**：生成中间推理步骤，显著提升数学和逻辑任务
- **Self-consistency**：多次采样取最一致答案
- **Tree of Thoughts (ToT)**：同时探索多条推理路径
- **ReAct (Reason & Act)**：结合推理与外部工具调用的代理范式
- **自动提示工程（APE）**：自动化提示生成和优化
